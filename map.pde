int[][] track1 = new int[][]{{4,4,4,4,4,4,4,4,4,4,4},
                             ...
                             {4,3,4,4,4,2,2,2,4,1,4},
                             {4,2,2,4,4,4,4,4,4,0,4},
                             {4,4,1,2,4,4,4,4,4,2,4},
                             {4,4,4,3,2,2,3,2,4,2,4},
                             {4,4,4,4,4,4,4,2,2,2,4},
                             {4,4,4,4,4,4,4,4,4,4,4}};
                             
int[][] track2 = new int[][]{{4,4,4,4,4,4,4,4,4,4,4},
                             {4,2,2,2,2,2,2,2,2,2,4},
                             {4,2,4,4,4,4,4,4,4,2,4},
                             {4,2,4,4,2,2,2,2,4,0,4},
                             {4,2,2,4,2,4,4,2,4,2,4},
                             {4,4,1,4,3,4,4,3,4,2,4},
                             {4,4,2,4,2,4,4,2,4,3,4},
                             {4,4,3,4,2,4,4,2,4,2,4},
...
void raceComplete(){
  t.stop();
  PImage f = loadImage("finish.png");
  imageMode(CENTER);
  image(f,0,0,4500,4500);
  delay(3000);
  if(bestTime == 0)
  bestTime = t.getTime();
